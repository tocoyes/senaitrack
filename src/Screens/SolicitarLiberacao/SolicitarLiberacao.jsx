...
import styles from './SolicitarLiberacao.module.css';
    ...
    <div className={'containerFull'}>
      <div className={'contents'}>
        <div className={'leftContent'}>
          <div className={styles.solicitarLiberacao}>
              ...
              <div className={styles.fields}>
                ...
                <label>
                  ...
                  >
                    ...
                    <option value={'Motivos pessoais'}>Outros</option>
                  </select>
                </label>
                <label>
                  Entrada / Saída
